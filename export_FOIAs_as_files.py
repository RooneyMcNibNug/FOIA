...
### Finnicking around with some Muckrock API scripting with the help of examples from 
### https://github.com/MuckRock/API-examples/ and a bit of spare time. Attempting to export
### all of a user's FOIA requests as files into a local directory. Rookie API coding...
...
user = "joliet_j" #<--- Put username here. Case sensitive.
